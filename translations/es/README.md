...
2. Selecciona **Comenzar con prueba gratuita**.
   ![Seleccionar Comenzar con prueba gratuita](../../../../translated_images/es/select-start-with-free-trial.6c2e287133ff9c8b.webp)
3. Selecciona **Iniciar sesión con GitHub**.  
   ![Iniciar sesión con GitHub](../../../../translated_images/es/select-sign-in-with-github.f2850ffdd49cc894.webp)
4. Inicia sesión con tu cuenta de GitHub.  
   ![Inicio de sesión de GitHub](../../../../translated_images/es/github-login.02bbaee0270b292e.webp)
5. Elige la cuenta en la que deseas instalar la aplicación Localizeflow de GitHub — tu cuenta personal o una organización que administres.  
   ![Seleccionar cuenta](../../../../translated_images/es/select-which-account-to-use.7050f5ed0b773bb0.webp)
6. Selecciona los repositorios a los que quieres que Localizeflow tenga acceso, luego elige **Guardar**.  
   ![Seleccionar repositorio y guardar](../../../../translated_images/es/select-repo-and-save.5a95ae288aefec6e.webp)
...
> ![Añadir más repositorios](../../../../translated_images/es/add-more-repo.2ca5154473aaaafb.webp)
...
1. En la página principal de Localizeflow, selecciona **+ Conectar repositorios**.  
   ![Seleccionar conectar repositorios](../../../../translated_images/es/select-connect-repos.8ac6f96f77dcc62c.webp)

2. Elige uno de los repositorios instalados que quieres conectar y selecciona **Guardar**.  
   ![Seleccionar repositorio](../../../../translated_images/es/select-repo.dce94db722b44cf3.webp)

3. Tus repositorios conectados aparecerán ahora tanto en la página principal como en la página de Repositorios.  
   ![Repositorios conectados](../../../../translated_images/es/repo-connected.9e5c21ee789fdcaa.webp)
...
1. Selecciona el repositorio que acabas de conectar.  
   ![Seleccionar repositorio](../../../../translated_images/es/select-repo-to-detail.55e53233531f8518.webp)

2. En la página del detalle del repositorio, selecciona **Editar** en la parte inferior.  
   ![Seleccionar editar](../../../../translated_images/es/select-edit.225184c8c46d7001.webp)
...
3. Configura tus ajustes de traducción — rama objetivo (predeterminado: `main`), idiomas objetivo y idioma fuente (predeterminado: `en`). Selecciona **Guardar**.  
   ![Configurar ajustes de traducción](../../../../translated_images/es/configuration.ab55d0f8bab5711b.webp)
...
4. Selecciona **Iniciar y Automatizar**.  
   ...
   ![Iniciar y Automatizar](../../../../translated_images/es/select-automate.ff50c8d913b35a03.webp)
