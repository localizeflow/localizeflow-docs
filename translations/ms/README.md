# Localizeflow – Panduan Mula Pantas
...
> Repositori ini merangkumi lebih 50+ terjemahan bahasa yang secara ketara meningkatkan saiz muat turun. Untuk klon tanpa terjemahan, gunakan sparse checkout:
> ```bash
...
Localizeflow secara automatik menterjemah dokumentasi anda dan membuka permintaan tarik (pull requests) setiap kali fail sumber berubah.  
Panduan ini menunjukkan cara memasang Apl GitHub dan menjalankan terjemahan pertama anda dalam masa kurang dari 2 minit.


> [!NOTE]
>
> Localizeflow kini menyokong projek dokumentasi berasaskan GitHub
> (contoh: AI untuk Pemula dan kebanyakan repositori sumber terbuka standard).  
> 
...
## Log masuk dan pasang Apl GitHub
