...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-11-18T11:13:10+00:00",
...
本指南將示範如何安裝 GitHub App 並在 2 分鐘內執行您的第一次翻譯。
...
> 
> 對於現代文件框架如 Astro、Docusaurus 和 Hugo 的支援  
> 正在積極開發中。
...
> [!TIP]
> 若要稍後新增更多倉庫，請在頁首選擇您的帳號，然後選擇 **+ Add more repositories**。  
...
3. 設定您的翻譯設定 — 目標分支（預設：`main`）、目標語言及來源語言（預設：`en`）。選擇 **Save**。  
   ![Configure translation settings](/images/configuration.png)

4. 選擇 **Start & Automate**。  
   Localizeflow 現在會自動翻譯您的文件，並在原始檔案變更時開啟拉取請求。  
